...
Sub GenererPlanningGOOGLELEADS(collabs() As Collaborateur, nb As Integer)
    ...
    ' Le shift 11H (index 5) est intrinsÃ¨quement un "shift rÃ©duit" :
    ' un agent affectÃ© au shift 5 a DÃ‰JÃ€ son quota de 1 shift rÃ©duit
...
Sub GenererPlanningTLV(collabs() As Collaborateur, nb As Integer)
    ...
    If ligne > 4 Then
        ligne = ligne + 1
        ws.Cells(ligne, 1).Value = "SHIFTS TLV | Shift 1: 08-17 | Shift 2: 09-18 | Pause entrÃ©e+5h"
        ws.Cells(ligne, 1).Font.Bold = True: ws.Cells(ligne, 1).Font.Color = RGB(31, 73, 125)
